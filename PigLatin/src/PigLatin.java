public class PigLatin {
	public static void main(String[] args) {
		System.out.println(translate("Ecksdee"));
	}
	...
	public static String lTranslate(String englishWord) {
		String xString = englishWord;
		englishWord = englishWord.toLowerCase();
		if (!(englishWord.contains("a") || englishWord.contains("e") || englishWord.contains("i")
				|| englishWord.contains("o") || englishWord.contains("u"))) {
			if (Character.isUpperCase(xString.charAt(0))) {
				return (englishWord.charAt(0) + "").toUpperCase() + englishWord.substring(1) + "ay";
			} else {
				return englishWord + "ay";
			}
		} else if (englishWord.charAt(0) == 'a' || englishWord.charAt(0) == 'e' || englishWord.charAt(0) == 'i'
		...
		} else if ((englishWord.contains("a") || englishWord.contains("e") || englishWord.contains("i")
				|| englishWord.contains("o") || englishWord.contains("u"))
				&& !(englishWord.charAt(0) == 'a' || englishWord.charAt(0) == 'e' || englishWord.charAt(0) == 'i'
						|| englishWord.charAt(0) == 'o' || englishWord.charAt(0) == 'u')) {
